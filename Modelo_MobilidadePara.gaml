...
global {
    ...
    init {
        create RegiaoAmbiental number: 8 {
            switch index {
                match 0 {
                    name <- "Belém Metropolitana";
                    center <- {50, 120};
                    radius <- 25;
                ...
                match 1 {
                    ...
                    center <- {80, 140};
                    radius <- 30;
                    environment_type <- "rural_costeiro";
                    max_capacity <- 12;
                    flood_risk <- 0.8;
                    sea_level_rise <- 0.05;
                    job_opportunities <- 3.0;
                }
                match 2 {
                    name <- "Sudeste Paraense";
                    center <- {150, 80};
                    radius <- 35;
                    environment_type <- "rural_mineracao";
                    max_capacity <- 18;
                    local_deforestation_rate <- 0.08;
                    mining_activity <- 0.7;
                    job_opportunities <- 6.0;
                }
                match 3 {
                    name <- "Oeste Paraense";
                    center <- {170, 120};
                    radius <- 32;
                    environment_type <- "rural_agropecuario";
                    max_capacity <- 15;
                    local_deforestation_rate <- 0.06;
                    agricultural_activity <- 0.8;
                    job_opportunities <- 5.5;
                }
                match 4 {
                    name <- "Baixo Amazonas";
                    center <- {120, 100};
                    radius <- 28;
                    environment_type <- "rural_tradicional";
                    max_capacity <- 10;
                    flood_risk <- 0.6;
                    traditional_communities <- 0.9;
                    job_opportunities <- 2.5;
                }
                match 5 {
                    name <- "Nordeste Paraense";
                    center <- {100, 130};
                    radius <- 25;
                    environment_type <- "rural_transicao";
                    max_capacity <- 12;
                    flood_risk <- 0.4;
                    job_opportunities <- 4.0;
                }
                match 6 {
                    name <- "Sul Paraense";
                    center <- {160, 50};
                    radius <- 30;
                    environment_type <- "fronteira_agricola";
                    max_capacity <- 14;
                    local_deforestation_rate <- 0.1;
                    land_conflicts <- 0.3;
                    job_opportunities <- 4.5;
                }
                match 7 {
                    name <- "Interior Amazônico";
                    center <- {90, 70};
                    radius <- 35;
                    environment_type <- "floresta_preservada";
                    max_capacity <- 8;
                    forest_cover <- 0.95;
                    job_opportunities <- 1.5;
                }
            }
        }
...
experiment Simulacao_MobilidadePara type: gui {
    ...
    output {
        ...
        display "Evolução da Mobilidade" {
        ...
        display "Análise de Fluxos Migratórios" {
        ...
        display "Impactos Climáticos e Sazonalidade" {
